...
//             (directive) =>
//               directive.name.value === "aws_subscribe" &&
//               directive.arguments[0].value.values.filter(
//                 (value) => value.value === mutationName
//               ).length > 0
//           ).length > 0
//       );
...
//           GraphqlResolver.#getAwsSubscribeMutationHandlers(
//             typeDefs,
//             handlerFncName
//           );
