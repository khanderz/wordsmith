...
function withSharingIntentAppBuildGradle(config) {
  return (0, config_plugins_1.withAppBuildGradle)(config, (config) => {
    if (
      !config.modResults.contents.includes('reactnativereceivesharingintent')
    ) {
      config.modResults.contents = config.modResults.contents.replace(
        /(\s*if\s*\(enableHermes\)\s*{)/,
        `\n\n${dependencyToAdd}$1`,
      )
    }
    return config
...
const withAndroidMainActivityExtension = (config) => {
  let _a, _b, _c
  if (
    ((_a = config.sdkVersion) === null || _a === void 0
      ? void 0
      : _a.includes('46.')) ||
    ((_b = config.sdkVersion) === null || _b === void 0
      ? void 0
      : _b.includes('47.')) ||
    ((_c = config.sdkVersion) === null || _c === void 0
      ? void 0
      : _c.includes('48.'))
  ) {
